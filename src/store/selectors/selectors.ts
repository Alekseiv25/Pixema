...
export const toggleFilterSelector = (state: GlobalState) => state.toggleFilter.isOpen
...
export const backogroundMovieSelector = (state: GlobalState) => state.backgroundMovie.movie
